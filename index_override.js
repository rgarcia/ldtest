...
var new_client = function(api_key, config) {
  ...
  client.initializeStream = function() {
    ...
    this.es.addEventListener('put', function(e) {
      console.log(new Date(), "this.es.addEventListener put");
      if (e && e.data) {
    ...
    this.es.addEventListener('patch', function(e) {
      console.log(new Date(), "this.es.addEventListener patch");
      if (e && e.data) {
        try {
    ...
    this.es.addEventListener('delete', function(e) {
      console.log(new Date(), "this.es.addEventListener delete");
      if (e && e.data) {
        try {
    ...
    this.es.onerror = function(e) {
      console.log(new Date(), "this.es.oneerror", JSON.stringify(e));
      if (e && e.status == 401) {
  ...
  client.toggle = function(key, user, default_val, fn) {
    ...
    if (this.stream && this.initialized) {
      ...
      if (this.disconnected && should_fallback_update(this.disconnected)) {
        ...
        function(error) {
          console.log(new Date(), "[LaunchDarkly] Failed to update feature in fallback mode. Flag values may be stale.");
        });
      }
